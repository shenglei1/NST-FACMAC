...
def run_sequential(args, logger):
    ...
    if 'particle' not in args.env and "cts_matrix_game" not in args.env and "mujoco_multi" not in args.env:
        ...
        scheme = {
            ...
            "fixed_zs":{"vshape": (args.zs_dim,), "group": "agents"},
            "fixed_target_zs": {"vshape": (args.zs_dim,), "group": "agents"},
            "next_zs": {"vshape": (args.zs_dim,), "group": "agents"},
            "zsa":{"vshape": (args.zs_dim,), "group": "agents"},
