...
class FACMACCritic_sz(nn.Module):
    def __init__(self, scheme, args):
        super(FACMACCritic_sz, self).__init__()
        self.input_obs = args.zs_dim
        self.args = args
